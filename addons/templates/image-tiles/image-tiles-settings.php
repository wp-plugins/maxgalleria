...
<div class="settings-options">
	...
	<form id="form-image-tiles-settings">
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><?php _e('Lightbox Captions Position:', 'maxgalleria') ?></td>
				<td>
					<select data-default="<?php echo $options->lightbox_caption_position_default_key ?>" id="<?php echo $options->lightbox_caption_position_default_key ?>" name="<?php echo $options->lightbox_caption_position_default_key ?>">
					<?php foreach ($options->caption_positions as $key => $name) { ?>
						<?php $selected = ($options->get_lightbox_caption_position_default() == $key) ? 'selected="selected"' : ''; ?>
						<option value="<?php echo $key ?>" <?php echo $selected ?>><?php echo $name ?></option>
					<?php } ?>
					</select>
				</td>
			...
			<tr>
				<td><?php _e('Lightbox Image Size:', 'maxgalleria') ?></td>
				<td>
					<select data-default="<?php echo $options->lightbox_image_size_default ?>" class="small" id="<?php echo $options->lightbox_image_size_default_key ?>" name="<?php echo $options->lightbox_image_size_default_key ?>">
					<?php foreach ($options->lightbox_sizes as $key => $name) { ?>
						<?php $selected = ($options->get_lightbox_image_size_default() == $key) ? 'selected="selected"' : ''; ?>
						<option value="<?php echo $key ?>" <?php echo $selected ?>><?php echo $name ?></option>
					<?php } ?>
					</select>
				</td>
			...
			<tr>
				<td><?php _e('Lightbox Image Custom Width:', 'maxgalleria') ?></td>
				<td>
					<input data-default="<?php echo $options->lightbox_image_size_custom_width_default ?>" type="text" class="small" id="<?php echo $options->lightbox_image_size_custom_width_default_key ?>" name="<?php echo $options->lightbox_image_size_custom_width_default_key ?>" value="<?php echo $options->get_lightbox_image_size_custom_width_default() ?>" /> px
				</td>
			</tr>
			<tr>
				<td><?php _e('Lightbox Image Custom Height:', 'maxgalleria') ?></td>
				<td>
					<input data-default="<?php echo $options->lightbox_image_size_custom_height_default ?>" type="text" class="small" id="<?php echo $options->lightbox_image_size_custom_height_default_key ?>" name="<?php echo $options->lightbox_image_size_custom_height_default_key ?>" value="<?php echo $options->get_lightbox_image_size_custom_height_default() ?>" /> px
				</td>
			</tr>
			<tr>
