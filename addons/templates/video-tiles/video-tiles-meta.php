...
<div class="meta-options">
	<table>
		...
		<tr>
			<td>
				<?php _e('Lightbox Video Size:', 'maxgalleria') ?>
			</td>
			<td>
				<select id="<?php echo $options->lightbox_video_size_key ?>" name="<?php echo $options->lightbox_video_size_key ?>">
		...
		<tr>
			<td>
				<?php _e('Lightbox Video Custom Width:', 'maxgalleria') ?>
			</td>
			<td>
		...
		<tr>
			<td>
				<?php _e('Lightbox Video Custom Height:', 'maxgalleria') ?>
			</td>
			<td>
